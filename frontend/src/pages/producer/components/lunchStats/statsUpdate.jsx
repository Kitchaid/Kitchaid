...
function UpdateStats() {
  ...
  const defaultData = location.state.props; console.log(defaultData);
  delete defaultData?.sides
  const { data, isLoading } = useQuery(["getStatById", _id], () => getStatById(_id));
  //Update stats.....
  const [updateStats, setUpdateStats] = useState(data?.data[0].sides);
  ...
  return (
    <>
      ...
      >
        ...
        <div className="mx-auto formFrame mb-3">
          <Row>
            <Col sm={12}>
              <label htmlFor="autoSizingInput"
              ><span className="text-dark font-size-s">Huvudkryddor(Smak) t.ex. Curry</span></label>
            </Col>
            <Col sm={12}>
              <input
                type="text"
                className="form-control"
                defaultValue={data?.data[0]?.mainSpices}
                name="mainSpices"
                disabled
              />
            </Col>
        ...
        <div className="mx-auto formFrame">
          <Row>
            <Col sm={12}>
              <label htmlFor="autoSizingInput"
              ><span className="text-dark font-size-s">Tilllagad/inköpta mängd t.ex. 70</span></label>
            </Col>
            <Col sm={12}>
              <input
                type="number"
        ...
        <div className="mx-auto formFrame d-block">
          <Row>
            <Col sm={12}>
              <label htmlFor="autoSizingInput"
              ><span className="text-dark font-size-s">Använd t.ex. 60</span></label>
            </Col>
            <Col sm={12}>
              <input
                type="number"
